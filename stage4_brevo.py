from common import DATA_DIR, domain_to_company_name, first_name, load_json, request_with_retries, require_env, save_json
...
def run(contacts: list[dict[str, str]], *, resume: bool = True, dry_run: bool = False) -> list[dict[str, str]]:
    ...
    for contact in pending:
        ...
        body = build_email_body(contact["name"], company_name)
...
def build_email_body(full_name: str, company_name: str) -> str:
